...
详细 **阶段计划与概念扫盲（前后端对照）** 见 [docs/transition-plan.md](docs/transition-plan.md)。**入门 Day 01** 见 [docs/day-01.md](docs/day-01.md)，索引 [docs/days.md](docs/days.md)，示例工程 `day01/`。
