...
详细 **阶段计划与概念扫盲（前后端对照）** 见 [docs/transition-plan.md](docs/transition-plan.md)。**入门 Job 01** 见 [docs/job-01.md](docs/job-01.md)，索引 [docs/jobs.md](docs/jobs.md)，示例工程 `job01/`。
